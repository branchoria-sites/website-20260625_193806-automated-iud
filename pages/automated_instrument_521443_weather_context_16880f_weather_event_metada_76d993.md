...
show_ads: true
description: Temperature, humidity, pressure, wind, cloud, precipitation and sensor status make a UAP clip reviewable instead of impressionistic.
hero_summary: Temperature, humidity, pressure, wind, cloud, precipitation and sensor status make a UAP clip reviewable instead of impressionistic.
layout: default
permalink: /event-metadata/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /weather/
nav_short_title: Event Metadata
title: What weather belongs in a UAP file?
title_full: What weather belongs in a UAP file?
display_title_short: Event Metadata
display_title: Event Metadata
heading_title: What weather belongs in a UAP file?
page_heading_title: What weather belongs in a UAP file?
source_count: 47
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why infrared skies can fool detectors
header:
  og_image: /assets/images/automated_instrument_521443_weather_context_16880f_weather_event_metada_76d993-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_weather_context_16880f_weather_event_metada_76d993-Illustration-1.webp
image: /assets/images/automated_instrument_521443_weather_context_16880f_weather_event_metada_76d993-Illustration-1-social.jpg
---

## Introduction

A defensible UAP event record is more than a video, photograph or sensor trace. It is a package of evidence that allows other investigators to determine what the observing system was looking through, whether the environment could have influenced the observation, and whether the recorded behaviour is consistent with known atmospheric conditions. [Weather]({{ 'weather/' | relative_url }}) metadata therefore serves as evidence, not decoration.
...
The objective is not to create a complete meteorological archive for every detection. Instead, the [event packet]({{ 'event-packet/' | relative_url }}) should preserve enough information that another analyst can independently reconstruct the observing conditions at the moment the event occurred.
...
* **[Visibility]({{ 'visibility/' | relative_url }})** or estimated atmospheric transparency.
...
* calibration date;
* sampling interval;
* measurement [uncertainty]({{ 'uncertainty/' | relative_url }}) where known;
...
* unknown visibility;
* inaccurate [timestamps]({{ 'timestamps/' | relative_url }});
