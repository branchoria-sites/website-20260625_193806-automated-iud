...
show_ads: true
description: UFODAP matters most when it turns hours of sky video into structured events that a reviewer can check after the fact.
hero_summary: UFODAP matters most when it turns hours of sky video into structured events that a reviewer can check after the fact.
layout: default
permalink: /event-triggers/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /ufodap/
nav_short_title: Event Triggers
title: When does sky motion become an event?
title_full: When does sky motion become an event?
display_title_short: Event Triggers
display_title: Event Triggers
heading_title: When does sky motion become an event?
page_heading_title: When does sky motion become an event?
source_count: 21
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: What keeps a detector from crying UFO?
header:
  og_image: /assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_event_trigger_7af226-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_event_trigger_7af226-Illustration-1.webp
image: /assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_event_trigger_7af226-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_event_trigger_7af226-Illustration-3-dark.svg" | relative_url }}" alt="Event Triggers illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_event_trigger_7af226-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_event_trigger_7af226-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. A camera continuously observes the sky.
...
6. The resulting files are stored as a discrete event for later examination. [UFODAP](https://ufodap.com/technology)
...
* [Timing]({{ 'timing/' | relative_url }}) information that allows comparison with external data.
* Tracking information from the optical system.
* Environmental context that may help explain the observation.
* Metadata that supports later identification efforts. [handprint.com](https://www.handprint.com/UFO/UFODAP_User_Guide.pdf)

UFODAP has also added automated analytics intended to reduce reviewer workload. According to project materials, the software can identify likely aircraft or birds and can incorporate estimated classifications and confidence information into event organisation. The purpose is not to prove that an object is extraordinary, but to help reviewers spend less time on routine detections and more time examining events that remain [unresolved]({{ 'unresolved/' | relative_url }}). [UFODAP](https://ufodap.com/technology)

This is a critical distinction. An event worthy of review is not necessarily anomalous. It is simply an observation that survived the system’s filtering [rules]({{ 'rules/' | relative_url }}) and was documented with enough context to support later analysis.
...
OTDAU's event-trigger approach converts that flood of video into discrete observations that can be checked against aircraft data, weather conditions, astronomical objects and other explanatory sources. The system therefore functions as a triage mechanism: motion becomes a candidate track, the candidate track becomes a recorded event, and only then does human analysis begin. [UFODAP+2handprint.com](https://ufodap.com/technology)
