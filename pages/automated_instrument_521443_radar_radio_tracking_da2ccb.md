...
- automated_instrument_521443_radar_radio_tracking_da2ccb_index
...
show_ads: true
description: Radio and radar-style sensing can add range, motion, and independent confirmation when optical evidence is uncertain.
hero_summary: Radio and radar-style sensing can add range, motion, and independent confirmation when optical evidence is uncertain.
layout: default
permalink: /radar/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
nav_short_title: Radar
title: Can Radar Make UAP Tracks Clearer?
title_full: Can Radar Make UAP Tracks Clearer?
display_title_short: Radar
display_title: Radar
heading_title: Can Radar Make UAP Tracks Clearer?
page_heading_title: Can Radar Make UAP Tracks Clearer?
source_count: 108
infographic_count: 3
planned_sections:
- Active radar versus passive radio sensing
- Why range and motion matter
- Practical limits for civilian stations
...
next_link:
  ...
  heading_title: What Happens After a Detector Triggers?
header:
  og_image: /assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-overview-social.jpg
  preview_image: /assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-overview.webp
image: /assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-overview-social.jpg
---
...
* **Radio-identification monitoring.** The station receives [ADS-B]({{ 'ads-b/' | relative_url }}), Mode S or similar aircraft-related broadcasts so ordinary traffic can be identified or ruled out.
...
<img src="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-Illustration-1-dark.svg" | relative_url }}" alt="Radar illustration 1" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<img src="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-Illustration-3-dark.svg" | relative_url }}" alt="Radar illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
