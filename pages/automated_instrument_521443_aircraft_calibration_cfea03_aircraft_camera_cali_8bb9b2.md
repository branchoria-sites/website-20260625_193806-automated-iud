...
show_ads: true
description: Known aircraft can turn a sky camera from a recorder into a measuring instrument by tying pixels to real directions and times.
hero_summary: Known aircraft can turn a sky camera from a recorder into a measuring instrument by tying pixels to real directions and times.
layout: default
...
title: How planes turn pixels into sky measurements
title_full: How planes turn pixels into sky measurements
display_title_short: Moving Targets
display_title: Moving Targets
heading_title: How planes turn pixels into sky measurements
page_heading_title: How planes turn pixels into sky measurements
source_count: 29
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How bad weather tests sky cameras
header:
  og_image: /assets/images/automated_instrument_521443_aircraft_calibration_cfea03_aircraft_camera_cali_8bb9b2-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_aircraft_calibration_cfea03_aircraft_camera_cali_8bb9b2-Illustration-1.webp
image: /assets/images/automated_instrument_521443_aircraft_calibration_cfea03_aircraft_camera_cali_8bb9b2-Illustration-1-social.jpg
---
...
1. **Acquire aircraft position data** from ADS-B broadcasts.
2. **Convert aircraft coordinates** into the local sky reference frame.
3. **Detect the aircraft in camera images** using tracking or machine-learning methods.
4. **Compare predicted and observed locations.**
5. **Adjust the camera model** until prediction and observation align as closely as possible.
...
* Gradual mount movement.
* Thermal expansion effects.
* Lens or sensor alignment drift.
* Timestamp errors.
* Detection algorithm weaknesses.
* Parts of the field of view where positional accuracy deteriorates.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses camera models, calibration, image coordinates, and mapping pixels to real-world directions.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers calibration, feature tracking, geometric transformations, and measurement accuracy.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides core image-processing concepts used before calibration and tracking analysis.</p>
        <div class="fr-book-actions">
