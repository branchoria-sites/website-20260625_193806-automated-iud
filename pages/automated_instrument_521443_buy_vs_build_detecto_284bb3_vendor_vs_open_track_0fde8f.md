...
show_ads: true
description: Commercial tracking can reduce setup work, while open code lets builders inspect thresholds, failures and updates directly.
hero_summary: Commercial tracking can reduce setup work, while open code lets builders inspect thresholds, failures and updates directly.
layout: default
permalink: /software-trust/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /buy-or-build/
nav_short_title: Software Trust
title: Should Sky Tracking Software Be Open?
title_full: Should Sky Tracking Software Be Open?
display_title_short: Software Trust
display_title: Software Trust
heading_title: Should Sky Tracking Software Be Open?
page_heading_title: Should Sky Tracking Software Be Open?
source_count: 33
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Weatherproofing
  heading_title: The Outdoor Problems That Break Sky Detectors
date: '2026-06-25 13:11:57 '
header:
  og_image: /assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-1.webp
image: /assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-1-social.jpg
---

## Introduction

Choosing between commercial sky-tracking software and [open-source]({{ 'open-source/' | relative_url }}) code is ultimately a question of trust rather than convenience. In an automated instrumented UAP detector, the software decides which pixels represent motion, which events are discarded as [false alarms]({{ 'false-alarms/' | relative_url }}), when recordings begin and end, and what metadata are preserved. Those decisions directly affect whether an unusual event can later be evaluated independently.
...
The trade-off is reduced [visibility]({{ 'visibility/' | relative_url }}) into how detections are produced. A user may know that an object was recorded but not precisely:

* what numerical thresholds triggered recording;
* which filtering [rules]({{ 'rules/' | relative_url }}) rejected competing objects;
...
<img src="{{ "/assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-2-dark.svg" | relative_url }}" alt="Software Trust illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why transparency improves reproducibility

For observational science, [reproducibility]({{ 'reproducibility/' | relative_url }}) extends beyond sharing images. Other investigators should be able to reconstruct how an event was detected.
...
<img src="{{ "/assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-3-dark.svg" | relative_url }}" alt="Software Trust illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_vendor_vs_open_track_0fde8f-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for open-source tracking software development.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains motion detection and tracking algorithms.</p>
        <div class="fr-book-actions">
