...
show_ads: true
description: A useful sky-station microphone setup needs calibration, time stamps, weather context and enough recording before and after each event.
hero_summary: A useful sky-station microphone setup needs calibration, time stamps, weather context and enough recording before and after each event.
layout: default
permalink: /audio-setup/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /acoustics/
nav_short_title: Audio Setup
title: What Makes Sky Audio Trustworthy?
title_full: What Makes Sky Audio Trustworthy?
display_title_short: Audio Setup
display_title: Audio Setup
heading_title: What Makes Sky Audio Trustworthy?
page_heading_title: What Makes Sky Audio Trustworthy?
source_count: 9
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Can a Buzz Point to a Drone?
header:
  og_image: /assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-1.webp
image: /assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-1-social.jpg
---
...
Without these elements, a recording may still be interesting, but it cannot easily be compared with observations from other stations or subjected to rigorous [review]({{ 'review/' | relative_url }}).
...
Time synchronisation is equally important. Audio files should use a common reference clock shared with cameras and other instruments, ideally disciplined by Global Navigation Satellite System (GNSS) timing or another traceable reference. Accurate [timestamps]({{ 'timestamps/' | relative_url }}) allow investigators to measure expected sound delays, compare simultaneous recordings between stations and determine whether an acoustic event could plausibly correspond to an observed object.

Clock quality should also be logged. A recording with known timing [uncertainty]({{ 'uncertainty/' | relative_url }}) is more valuable than one whose accuracy is unknown.
...
[Pre-trigger]({{ 'pre-trigger/' | relative_url }}) recording helps determine whether an aircraft, drone or vehicle was already audible before appearing in the camera. Post-trigger recording allows delayed sound arrivals to be measured. Because sound travels much more slowly than light, an object several kilometres away may be seen well before any associated acoustic signal reaches the station.
...
<img src="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-2-dark.svg" | relative_url }}" alt="Audio Setup illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Metadata that keeps audio evidence reviewable
...
* [Weather]({{ 'weather/' | relative_url }}) observations, including wind speed, rainfall, humidity and temperature.
...
<img src="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-3-dark.svg" | relative_url }}" alt="Audio Setup illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_calibrated_sky_audio_4a1998-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers measurement fundamentals behind trustworthy audio.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains microphone behavior and acoustic recording.</p>
        <div class="fr-book-actions">
