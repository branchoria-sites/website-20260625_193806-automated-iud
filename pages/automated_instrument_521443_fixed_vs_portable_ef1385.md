...
- automated_instrument_521443_fixed_vs_portable_ef1385_index
...
show_ads: true
description: Fixed stations build baselines, while portable systems can chase hotspots, tests, and national-security needs.
hero_summary: Fixed stations build baselines, while portable systems can chase hotspots, tests, and national-security needs.
layout: default
permalink: /fixed-vs-portable/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
nav_short_title: Fixed vs Portable
title: Should UAP Sensors Stay Put or Move?
title_full: Should UAP Sensors Stay Put or Move?
display_title_short: Fixed vs Portable
display_title: Fixed vs Portable
heading_title: Should UAP Sensors Stay Put or Move?
page_heading_title: Should UAP Sensors Stay Put or Move?
source_count: 93
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: What Would an Academic UAP Observatory Measure?
header:
  og_image: /assets/images/automated_instrument_521443_fixed_vs_portable_ef1385-overview-social.jpg
  preview_image: /assets/images/automated_instrument_521443_fixed_vs_portable_ef1385-overview.webp
image: /assets/images/automated_instrument_521443_fixed_vs_portable_ef1385-overview-social.jpg
---

## Introduction

A UAP detector station can either stay in one place for months or years, or move to wherever reports, tests, exercises, [weather]({{ 'weather/' | relative_url }}) patterns or national-security concerns make collection most urgent. The choice changes almost everything: what the station can learn, how well its data can be calibrated, how much power and weather protection it needs, and whether it can distinguish a genuinely unusual event from the ordinary clutter of aircraft, [satellites]({{ 'satellites/' | relative_url }}), birds, insects, clouds, camera artefacts and local radio noise.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Connects instrumented collection debates to the broader public UAP evidence problem.</p>
