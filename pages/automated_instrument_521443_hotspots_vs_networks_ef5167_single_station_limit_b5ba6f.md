...
show_ads: true
description: Single-site detections can be intriguing, but distance, altitude and identity often require corroboration from other sensors or stations.
hero_summary: Single-site detections can be intriguing, but distance, altitude and identity often require corroboration from other sensors or stations.
layout: default
permalink: /one-station/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /hotspots/
nav_short_title: One Station
title: When One UAP Station Is Not Enough
title_full: When One UAP Station Is Not Enough
display_title_short: One Station
display_title: One Station
heading_title: When One UAP Station Is Not Enough
page_heading_title: When One UAP Station Is Not Enough
source_count: 14
infographic_count: 3
planned_sections:
...
header:
  og_image: /assets/images/automated_instrument_521443_hotspots_vs_networks_ef5167_single_station_limit_b5ba6f-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_hotspots_vs_networks_ef5167_single_station_limit_b5ba6f-Illustration-1.webp
image: /assets/images/automated_instrument_521443_hotspots_vs_networks_ef5167_single_station_limit_b5ba6f-Illustration-1-social.jpg
---
...
Within the broader question of hotspot monitoring versus random-sky coverage, this distinction is important. A hotspot station may detect recurring events efficiently, but confirming what those events actually are often requires observations from somewhere else.
...
Those are valuable observations, but they leave important physical quantities [unresolved]({{ 'unresolved/' | relative_url }}).
...
This [uncertainty]({{ 'uncertainty/' | relative_url }}) affects several key measurements:
...
* a [known aircraft]({{ 'known-aircraft/' | relative_url }}),
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains what calibrated optical systems can and cannot measure.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for interpreting optical measurements.</p>
        <div class="fr-book-actions">
