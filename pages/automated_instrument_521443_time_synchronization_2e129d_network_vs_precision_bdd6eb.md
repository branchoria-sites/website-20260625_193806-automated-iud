...
show_ads: true
description: NTP can help with coarse logging, but frame-level reconstruction may need tighter local synchronization such as precision network timing.
hero_summary: NTP can help with coarse logging, but frame-level reconstruction may need tighter local synchronization such as precision network timing.
layout: default
permalink: /network-time/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /timing/
nav_short_title: Network Time
title: Is Internet Time Good Enough for UAP Video?
title_full: Is Internet Time Good Enough for UAP Video?
display_title_short: Network Time
display_title: Network Time
heading_title: Is Internet Time Good Enough for UAP Video?
page_heading_title: Is Internet Time Good Enough for UAP Video?
source_count: 64
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Do the Video and Logs Tell One Story?
header:
  og_image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_network_vs_precision_bdd6eb-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_network_vs_precision_bdd6eb-Illustration-1.webp
image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_network_vs_precision_bdd6eb-Illustration-1-social.jpg
---
...
* ordering event logs;
* matching observations with [weather]({{ 'weather/' | relative_url }}) records or aircraft databases;
* identifying whether multiple stations were active during the same general time window;
* maintaining consistent [timestamps]({{ 'timestamps/' | relative_url }}) across archived files.
...
* geographically [separated stations]({{ 'triangulation-f8259a/' | relative_url }}) with disciplined clocks can more confidently compare simultaneous observations.
...
<img src="{{ "/assets/images/automated_instrument_521443_time_synchronization_2e129d_network_vs_precision_bdd6eb-Illustration-2-dark.svg" | relative_url }}" alt="Network Time illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_time_synchronization_2e129d_network_vs_precision_bdd6eb-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_time_synchronization_2e129d_network_vs_precision_bdd6eb-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/tF48vjVxUO0" title="IEEE 1588 Precision Time Protocol (PTP)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=tF48vjVxUO0" target="_blank" rel="noopener noreferrer">IEEE 1588 Precision Time Protocol (PTP)</a></p><p class="youtube-embed-meta">Channel: Bruce Hartpence - Learning Networks</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=tF48vjVxUO0" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=tF48vjVxUO0">Open on YouTube</a></p></div></div></div>
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides background on digital measurement pipelines.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Relevant for synchronized multi-sensor vision.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context for precision timing versus network timing.</p>
        <div class="fr-book-actions">
