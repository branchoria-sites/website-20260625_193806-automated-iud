...
show_ads: true
description: Very low-frequency sound can arrive after a bright meteor and help separate a distant shock event from a nearby aircraft or drone.
hero_summary: Very low-frequency sound can arrive after a bright meteor and help separate a distant shock event from a nearby aircraft or drone.
layout: default
permalink: /meteor-sound/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /acoustics/
nav_short_title: Meteor Sound
title: The Delayed Boom After a Meteor
title_full: The Delayed Boom After a Meteor
display_title_short: Meteor Sound
display_title: Meteor Sound
heading_title: The Delayed Boom After a Meteor
page_heading_title: The Delayed Boom After a Meteor
source_count: 42
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When a Quiet UFO Is Not Silent
header:
  og_image: /assets/images/automated_instrument_521443_acoustic_sensors_4dced1_meteor_infrasound_761c4e-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_acoustic_sensors_4dced1_meteor_infrasound_761c4e-Illustration-1.webp
image: /assets/images/automated_instrument_521443_acoustic_sensors_4dced1_meteor_infrasound_761c4e-Illustration-1-social.jpg
---
...
For [automated instrumented UFO detectors]({{ 'automated-instrumented-ufo-detectors/' | relative_url }}), infrasound is valuable because it provides an independent measurement that can either support or weaken a meteor explanation. When a brilliant fireball is followed by a delayed low-frequency signal arriving from the correct direction and with the expected [timing]({{ 'timing/' | relative_url }}), the combined evidence strongly favours a distant atmospheric bolide over a nearby aircraft, drone or ground-level blast.
...
<img src="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_meteor_infrasound_761c4e-Illustration-2-dark.svg" | relative_url }}" alt="Meteor Sound illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_meteor_infrasound_761c4e-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_acoustic_sensors_4dced1_meteor_infrasound_761c4e-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why audible silence can still fit a meteor

Witnesses often report that a spectacular fireball was "completely silent". Without understanding atmospheric [acoustics]({{ 'acoustics/' | relative_url }}), this can seem inconsistent with such an energetic event.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides background on atmospheric sound propagation.</p>
        <div class="fr-book-actions">
