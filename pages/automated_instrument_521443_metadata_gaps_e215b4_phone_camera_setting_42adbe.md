...
show_ads: true
description: Zoom, autofocus, exposure, stabilisation and infrared modes can make ordinary lights look like blobs, discs, jumps or pulsing objects.
hero_summary: Zoom, autofocus, exposure, stabilisation and infrared modes can make ordinary lights look like blobs, discs, jumps or pulsing objects.
layout: default
permalink: /camera-effects/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /metadata/
nav_short_title: Camera Effects
title: Is the UFO in the Sky or Camera?
title_full: Is the UFO in the Sky or Camera?
display_title_short: Camera Effects
display_title: Camera Effects
heading_title: Is the UFO in the Sky or Camera?
page_heading_title: Is the UFO in the Sky or Camera?
source_count: 43
infographic_count: 3
planned_sections:
- Zoom, focus and exposure traps
- Stabilisation jumps and digital artefacts
- Why sensor settings belong in every record
...
next_link:
  ...
  heading_title: Can a UFO Clip Survive the Sharing Chain?
header:
  og_image: /assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-1.webp
image: /assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-1-social.jpg
---

## Introduction

A surprising number of “UFO” videos are actually recordings of camera behaviour rather than recordings of unusual objects. Modern smartphones do not simply capture light. They continuously adjust focus, exposure, image stabilisation, sharpening, noise reduction and digital zoom while recording. When a bright light appears against a dark sky, these systems can transform an ordinary star, planet, aircraft light, satellite or distant lamp into a glowing orb, pulsing disc, jumping object or apparently shape-changing anomaly.
...
The key question is often not “What is the object?” but “What did the camera do to the object?”
...
### Digital zoom turns points into blobs
...
As focus shifts during recording, the apparent UFO may seem to grow, shrink, pulsate or change shape even though the underlying light source remains unchanged.
...
### Bright lights can appear to pulse

Many witnesses report lights that seem to expand and contract rhythmically.

Often the cause is automatic exposure adjustment. Smartphones constantly attempt to maintain an average brightness level. When a bright light dominates a dark frame, the camera may repeatedly alter gain and exposure settings. The result can look like a glowing object that is breathing, pulsing or changing energy output.

Atmospheric turbulence can amplify the illusion. Small fluctuations caused by air movement become exaggerated when combined with autofocus and exposure corrections.

### Bokeh can mimic structured craft
...
<img src="{{ "/assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-2-dark.svg" | relative_url }}" alt="Camera Effects illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Stabilisation Jumps and Digital Artefacts
...
* Noise reduction can smear faint lights.
* Frame interpolation can alter motion.
* Compression can create halos around bright objects.
* Sharpening algorithms can generate artificial edges.
* Multi-frame processing can produce ghost images.

</div>

These effects are particularly visible at night, when smartphone cameras operate near the limits of their sensors.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/o8umYCt4tec" title="Smartphone Astrophotography Workshop" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=o8umYCt4tec" target="_blank" rel="noopener noreferrer">Smartphone Astrophotography Workshop</a></p><p class="youtube-embed-meta">Channel: IAU Office for Astronomy Outreach</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=o8umYCt4tec" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=o8umYCt4tec">Open on YouTube</a></p></div></div></div>

## Infrared Sensitivity and Invisible Light
...
## A Practical Example: The Planet That Became a UFO

A recurring pattern in UFO investigations involves bright planets such as Venus or Jupiter.

Viewed with the naked eye, the planet appears as a bright point. Recorded through a smartphone at high zoom, slightly out of focus, and under aggressive night-mode processing, it can become:


<div class="content-enhancement content-enhancement--example" markdown="1">

* A large glowing orb.
* A disc with apparent internal structure.
* A colour-changing object.
* A pulsing light.
* An object that seems to hover motionless.

</div>

None of these appearances necessarily reflect the physical appearance of the planet. They are often products of magnification, focus errors and image processing acting on a bright point source.

This is one reason experienced astronomical observers frequently ask for the original file and camera settings before assessing unusual footage.


<img src="{{ "/assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-3-dark.svg" | relative_url }}" alt="Camera Effects illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_metadata_gaps_e215b4_phone_camera_setting_42adbe-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why Sensor Settings Belong in Every Record

For [automated instrumented UFO detectors]({{ 'automated-instrumented-ufo-detectors/' | relative_url }}), the lesson is straightforward: a video alone is not enough.

A scientifically useful observation should record:
...
* Additional sensor measurements where available.
