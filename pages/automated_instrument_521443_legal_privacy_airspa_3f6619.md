...
- automated_instrument_521443_legal_privacy_airspa_3f6619_index
...
show_ads: true
description: A detector pointed at the sky can still raise questions about privacy, aircraft data, site security, and responsible sharing.
hero_summary: A detector pointed at the sky can still raise questions about privacy, aircraft data, site security, and responsible sharing.
layout: default
permalink: /rules/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
nav_short_title: Rules
title: What Rules Apply to Sky Monitoring Stations?
title_full: What Rules Apply to Sky Monitoring Stations?
display_title_short: Rules
display_title: Rules
heading_title: What Rules Apply to Sky Monitoring Stations?
page_heading_title: What Rules Apply to Sky Monitoring Stations?
source_count: 245
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Can Citizen Stations Watch the Sky Better?
header:
  og_image: /assets/images/automated_instrument_521443_legal_privacy_airspa_3f6619-overview-social.jpg
  preview_image: /assets/images/automated_instrument_521443_legal_privacy_airspa_3f6619-overview.webp
image: /assets/images/automated_instrument_521443_legal_privacy_airspa_3f6619-overview-social.jpg
---

## Introduction

Automated sky monitoring stations do not normally need special “UFO detector” permission simply because a camera is pointed upwards. The harder questions are ordinary governance questions: does the system capture identifiable people, homes, number plates or voices; does it collect and republish aircraft tracking data; does it operate near sensitive sites; and does it use any active equipment, such as transmitters, [radar]({{ 'radar/' | relative_url }}) or lasers, that could affect spectrum use or aviation safety. A credible UAP station is therefore not just a sensor stack. It is also a privacy, aviation-data and [disclosure]({{ 'disclosure/' | relative_url }}) system.
...
* **Immediate internal record:** preserve [raw data]({{ 'raw-data/' | relative_url }}), clocks, calibration, sensor settings and local processing logs so the event can be audited later.
