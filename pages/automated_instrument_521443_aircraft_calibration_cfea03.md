...
- automated_instrument_521443_aircraft_calibration_cfea03_index
...
show_ads: true
description: Known aircraft are not distractions from UAP detection; they are essential calibration targets for serious sky sensors.
hero_summary: Known aircraft are not distractions from UAP detection; they are essential calibration targets for serious sky sensors.
layout: default
permalink: /calibration/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
nav_short_title: Calibration
title: Why UFO Detectors Need Ordinary Planes
title_full: Why UFO Detectors Need Ordinary Planes
display_title_short: Calibration
display_title: Calibration
heading_title: Why UFO Detectors Need Ordinary Planes
page_heading_title: Why UFO Detectors Need Ordinary Planes
source_count: 127
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why UAP Detectors Need Computers On Site
header:
  og_image: /assets/images/automated_instrument_521443_aircraft_calibration_cfea03-overview-social.jpg
  preview_image: /assets/images/automated_instrument_521443_aircraft_calibration_cfea03-overview.webp
image: /assets/images/automated_instrument_521443_aircraft_calibration_cfea03-overview-social.jpg
---
...
<img src="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-1-dark.svg" | relative_url }}" alt="Calibration illustration 1" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How aircraft help calibrate cameras
...
<img src="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-2-dark.svg" | relative_url }}" alt="Calibration illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. **Collect local aircraft data.** Use an on-site ADS-B receiver where possible, because local reception gives the detector its own time-aligned aircraft stream rather than relying only on a third-party display.
2. **Synchronise clocks.** A one- or two-second timing error can matter when matching fast angular motion. The detector, ADS-B receiver and data logger should share reliable timekeeping.
3. **Map pixels to sky directions.** Use known aircraft passes, stars where visible, landmarks, or other reference methods to maintain a calibrated relationship between image coordinates and azimuth/elevation.
4. **Label aircraft tracks instead of deleting them.** Keep known aircraft in a training and validation dataset. They are useful for measuring detection efficiency, tracking stability and weather-related performance.
5. **Audit misses and mismatches.** When ADS-B says an aircraft should be visible but the detector misses it, the failure is informative. When the detector sees a track but ADS-B has no match, that event moves into a broader triage process rather than becoming automatically anomalous.
6. **Recalibrate after changes.** A moved camera, software update, new lens, different exposure setting or seasonal change in sky background can alter performance. Ordinary aircraft provide ongoing checks.
...
<img src="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-3-dark.svg" | relative_url }}" alt="Calibration illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_aircraft_calibration_cfea03-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
