...
show_ads: true
description: Passive radar can turn a moving light from a flat video dot into a track with distance, motion and uncertainty limits.
hero_summary: Passive radar can turn a moving light from a flat video dot into a track with distance, motion and uncertainty limits.
layout: default
permalink: /passive-range/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /radar/
nav_short_title: Passive Range
title: Can passive radar give UAP videos real distance?
title_full: Can passive radar give UAP videos real distance?
display_title_short: Passive Range
display_title: Passive Range
heading_title: Can passive radar give UAP videos real distance?
page_heading_title: Can passive radar give UAP videos real distance?
source_count: 36
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why backyard radar is not a casual upgrade
header:
  og_image: /assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-1.webp
image: /assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-1-social.jpg
---
...
1. A wide-field camera detects and tracks a moving object in image coordinates.
2. Passive radar independently detects a reflection associated with the same time and direction.
3. Delay measurements constrain the object's distance from the transmitter-receiver geometry.
4. Doppler measurements estimate motion towards or away from the receiver.
5. Software combines both datasets to estimate a three-dimensional trajectory together with statistical confidence limits.
...
* radial velocity;
* uncertainty bounds;
* consistency with [known aircraft]({{ 'known-aircraft/' | relative_url }}) performance.
...
<img src="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-2-dark.svg" | relative_url }}" alt="Passive Range illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<img src="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-3-dark.svg" | relative_url }}" alt="Passive Range illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_radar_radio_tracking_da2ccb_passive_radar_range_d64db3-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Where passive radar still leaves uncertainty
