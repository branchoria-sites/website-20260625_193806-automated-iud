...
show_ads: true
description: A station should test weather, clock, camera motion and sensor status before treating a strange recording as an unexplained event.
hero_summary: A station should test weather, clock, camera motion and sensor status before treating a strange recording as an unexplained event.
layout: default
permalink: /health-checks/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /edge-computer/
nav_short_title: Health Checks
title: Is the sky event real or the station misbehaving?
title_full: Is the sky event real or the station misbehaving?
display_title_short: Health Checks
display_title: Health Checks
heading_title: Is the sky event real or the station misbehaving?
page_heading_title: Is the sky event real or the station misbehaving?
source_count: 23
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why the seconds before a trigger matter
header:
  og_image: /assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-1.webp
image: /assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-1-social.jpg
---
...
Within an [edge-computing]({{ 'edge-computer/' | relative_url }}) architecture, these health checks should happen automatically before an event is promoted to a high-priority alert. Rather than simply detecting an unusual object, the station should continuously assess whether its own measurements remain scientifically valid.
...
* Are [timestamps]({{ 'timestamps/' | relative_url }}) still synchronised?
...
Modern sky stations combine optical cameras, infrared sensors, radio receivers, microphones and aircraft databases. Their usefulness depends on accurate [timing]({{ 'timing/' | relative_url }}).
...
<img src="{{ "/assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-2-dark.svg" | relative_url }}" alt="Health Checks illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Detecting station movement

One of the simplest ways to eliminate [false alerts]({{ 'false-alerts/' | relative_url }}) is to measure whether the camera itself moved.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/cZyQQulUrgM" title="Health Monitoring with Wireless Sensors and Machine Learning" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=cZyQQulUrgM" target="_blank" rel="noopener noreferrer">Health Monitoring with Wireless Sensors and Machine Learning</a></p><p class="youtube-embed-meta">Channel: Simons Institute for the Theory of Computing</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=cZyQQulUrgM" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=cZyQQulUrgM">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-3-dark.svg" | relative_url }}" alt="Health Checks illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_edge_computing_ad654a_sensor_health_checks_b780ad-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
