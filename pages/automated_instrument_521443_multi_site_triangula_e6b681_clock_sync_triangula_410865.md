...
show_ads: true
description: Even tiny timing errors can turn two good sky videos into a misleading distance estimate.
hero_summary: Even tiny timing errors can turn two good sky videos into a misleading distance estimate.
layout: default
permalink: /clock-sync/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /triangulation/
nav_short_title: Clock Sync
title: When two cameras disagree on time
title_full: When two cameras disagree on time
display_title_short: Clock Sync
display_title: Clock Sync
heading_title: When two cameras disagree on time
page_heading_title: When two cameras disagree on time
source_count: 17
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Meteor Lessons
  heading_title: What meteor hunters already solved
date: '2026-06-25 13:29:46 '
header:
  og_image: /assets/images/automated_instrument_521443_multi_site_triangula_e6b681_clock_sync_triangula_410865-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_multi_site_triangula_e6b681_clock_sync_triangula_410865-Illustration-1.webp
image: /assets/images/automated_instrument_521443_multi_site_triangula_e6b681_clock_sync_triangula_410865-Illustration-1-social.jpg
---
...
* **Object speed.** Fast-moving aircraft, meteors or [satellites]({{ 'satellites/' | relative_url }}) change position noticeably even over tens of milliseconds.
* **Distance from the cameras.** Small angular shifts translate into large positional errors for distant targets.
* **Camera baseline.** Stations separated by kilometres gain better ranging capability but also become more sensitive to [timing errors]({{ 'timing-errors/' | relative_url }}) because the viewing geometry is tighter.
...
<img src="{{ "/assets/images/automated_instrument_521443_multi_site_triangula_e6b681_clock_sync_triangula_410865-Illustration-2-dark.svg" | relative_url }}" alt="Clock Sync illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_multi_site_triangula_e6b681_clock_sync_triangula_410865-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_multi_site_triangula_e6b681_clock_sync_triangula_410865-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How timing errors distort speed and altitude
...
These offsets affect more than estimated position. Once three-dimensional positions are reconstructed over time, analysts calculate velocity and sometimes [acceleration]({{ 'acceleration/' | relative_url }}). Any systematic timestamp error therefore propagates into every downstream calculation.
