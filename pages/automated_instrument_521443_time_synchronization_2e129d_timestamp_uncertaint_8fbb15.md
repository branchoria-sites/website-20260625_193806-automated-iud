...
show_ads: true
description: A useful event record should say not only what time it claims, but also how uncertain that time is and where the uncertainty came from.
hero_summary: A useful event record should say not only what time it claims, but also how uncertain that time is and where the uncertainty came from.
layout: default
...
title: A Timestamp Without Uncertainty Is Not Enough
title_full: A Timestamp Without Uncertainty Is Not Enough
display_title_short: Uncertainty
display_title: Uncertainty
heading_title: A Timestamp Without Uncertainty Is Not Enough
page_heading_title: A Timestamp Without Uncertainty Is Not Enough
source_count: 38
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: Two Cameras Help Only If Their Clocks Agree
header:
  og_image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_timestamp_uncertaint_8fbb15-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_timestamp_uncertaint_8fbb15-Illustration-1.webp
image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_timestamp_uncertaint_8fbb15-Illustration-1-social.jpg
---
...
Digital systems routinely display [timestamps]({{ 'timestamps/' | relative_url }}) with millisecond or microsecond resolution regardless of whether that resolution reflects actual measurement accuracy. A camera may save timestamps with three decimal places simply because its software uses that format, not because the exposure time is known to within one millisecond.
...
* [Network Time]({{ 'network-time/' | relative_url }}) Protocol (NTP) variation caused by changing network latency;
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/CU1TRVk6yUc" title="Curios Pilot: UAP Investigation Example" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=CU1TRVk6yUc" target="_blank" rel="noopener noreferrer">Curios Pilot: UAP Investigation Example</a></p><p class="youtube-embed-meta">Channel: Philip Giacalone &middot; Views: 41 &middot; Uploaded: May 2026 &middot; Length: 3 minutes 24 seconds</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=CU1TRVk6yUc" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=CU1TRVk6yUc">Open on YouTube</a></p></div></div></div>
