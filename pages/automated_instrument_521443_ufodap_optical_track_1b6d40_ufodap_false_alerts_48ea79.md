...
show_ads: true
description: UFODAP-style systems must reduce routine sky traffic before any remaining track can be treated as interesting.
hero_summary: UFODAP-style systems must reduce routine sky traffic before any remaining track can be treated as interesting.
layout: default
permalink: /false-alerts/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /ufodap/
nav_short_title: False Alerts
title: What keeps a detector from crying UFO?
title_full: What keeps a detector from crying UFO?
display_title_short: False Alerts
display_title: False Alerts
heading_title: What keeps a detector from crying UFO?
page_heading_title: What keeps a detector from crying UFO?
source_count: 45
infographic_count: 3
planned_sections:
- Common ordinary targets in sky footage
- How automated labels can reduce review time
- Why fuller context often changes the case
...
next_link:
  ...
  heading_title: What does a real starter station need?
header:
  og_image: /assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_false_alerts_48ea79-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_false_alerts_48ea79-Illustration-1.webp
image: /assets/images/automated_instrument_521443_ufodap_optical_track_1b6d40_ufodap_false_alerts_48ea79-Illustration-1-social.jpg
---
...
### Aircraft are usually the biggest source of detections
...
### Insects can dominate close-range detections

Many dramatic-looking recordings originate only a few centimetres or metres from the lens. Insects crossing a camera's field of view can appear as bright spheres, elongated streaks, translucent shapes or rapidly manoeuvring objects. Because the camera lacks depth information, a nearby insect may appear much larger and faster than it truly is.

This problem becomes worse at night when infrared illumination or long exposure settings make insects highly visible while suppressing visual cues that would reveal their actual distance.

## Why artefacts can look more mysterious than real objects

Not every detection corresponds to a physical object in the monitored airspace. Some originate within the imaging system itself.

Common artefact sources include:

* Sensor noise in low-light conditions.
* Compression artefacts in digital video streams.
* Motion blur from long exposures.
* Focus changes and autofocus hunting.
* Lens reflections and internal reflections.
* Bright stars or planets distorted by atmospheric turbulence.
...
1. Detect motion or a candidate target.
2. Track it long enough to gather behavioural information.
3. Compare the track against known classes.
4. Assign a probability rather than a definitive label.
5. Escalate only uncertain cases for human review.

</div>

The value comes from reducing analyst workload. If thousands of routine detections can be categorised automatically, the remaining small percentage of uncertain events become more manageable for detailed examination.

Importantly, confidence scores matter. A detector that labels every object with unjustified certainty risks hiding classification mistakes. A detector that records uncertainty allows reviewers to revisit difficult cases.
...
Many apparently unusual recordings become ordinary once additional information is added.
...
* Earlier and later portions of the recording.
