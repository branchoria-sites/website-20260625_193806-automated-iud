...
show_ads: true
description: Matching aircraft to video means turning reported positions into image locations, not just checking a separate flight map.
hero_summary: Matching aircraft to video means turning reported positions into image locations, not just checking a separate flight map.
layout: default
permalink: /track-projection/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /ads-b/
nav_short_title: Track Projection
title: How Aircraft Tracks Land in Video
title_full: How Aircraft Tracks Land in Video
display_title_short: Track Projection
display_title: Track Projection
heading_title: How Aircraft Tracks Land in Video
page_heading_title: How Aircraft Tracks Land in Video
source_count: 18
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: Why Seconds Matter in UAP Footage
header:
  og_image: /assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3_aircraft_track_proje_5049d9-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3_aircraft_track_proje_5049d9-Illustration-1.webp
image: /assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3_aircraft_track_proje_5049d9-Illustration-1-social.jpg
---
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/nRVuLFQ_Bng" title="Mapping the 3D World to an Image - 5 Minutes with Cyrill" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=nRVuLFQ_Bng" target="_blank" rel="noopener noreferrer">Mapping the 3D World to an Image - 5 Minutes with Cyrill</a></p><p class="youtube-embed-meta">Channel: Cyrill Stachniss</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=nRVuLFQ_Bng" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=nRVuLFQ_Bng">Open on YouTube</a></p></div></div></div>


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/x6YIwoQBBxA" title="Camera Calibration with MATLAB" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=x6YIwoQBBxA" target="_blank" rel="noopener noreferrer">Camera Calibration with MATLAB</a></p><p class="youtube-embed-meta">Channel: MATLAB</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=x6YIwoQBBxA" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=x6YIwoQBBxA">Open on YouTube</a></p></div></div></div>

## Turning Aircraft Coordinates into Image Pixels

[ADS-B]({{ 'ads-b/' | relative_url }}) reports provide aircraft positions in geographic coordinates together with altitude and [timestamps]({{ 'timestamps/' | relative_url }}). These must first be converted into a common three-dimensional coordinate system relative to the observing camera.

The projection process is conceptually straightforward:


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/k-N6mFycM_8" title="I Built a Ceiling Projection Mapping of the Planes Flying Over My House || ViralHog" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=k-N6mFycM_8" target="_blank" rel="noopener noreferrer">I Built a Ceiling Projection Mapping of the Planes Flying Over My House || ViralHog</a></p><p class="youtube-embed-meta">Channel: ViralHog</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=k-N6mFycM_8" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=k-N6mFycM_8">Open on YouTube</a></p></div></div></div>


<img src="{{ "/assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3_aircraft_track_proje_5049d9-Illustration-2-dark.svg" | relative_url }}" alt="Track Projection illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3_aircraft_track_proje_5049d9-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3_aircraft_track_proje_5049d9-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
5. Correct for lens distortion to predict the final pixel location. [MDPI+2Wikipedia](https://www.mdpi.com/1424-8220/25/3/783)
...
If the aircraft lies outside the camera's field of view, projects below the horizon or falls behind an obstruction, the system can reject it immediately as an explanation for that particular detection. Likewise, if the predicted position agrees closely with the detected object over many consecutive frames, the aircraft becomes a strong candidate for identification. [MDPI](https://www.mdpi.com/1424-8220/25/3/783)
...
The [Galileo]({{ 'galileo/' | relative_url }}) Project has described using ADS-B-equipped aircraft to determine camera orientation by matching aircraft image positions with their known three-dimensional trajectories. As an aircraft traverses the sky, multiple image measurements become available, producing a sequence of corresponding world coordinates and pixel locations. These correspondences allow estimation of the camera's pose using the well-established Perspective-n-Point (PnP) method implemented in computer vision libraries such as OpenCV. [MDPI](https://www.mdpi.com/1424-8220/25/3/783)
...
* it allows [infrared cameras]({{ 'infrared/' | relative_url }}) to be calibrated using the same aircraft observed in visible-light systems;
* it provides an objective test of whether the geometric model remains accurate over time. [MDPI](https://www.mdpi.com/1424-8220/25/3/783)
...
* **Persistence:** agreement should continue over many frames rather than occurring by chance in a single image. [MDPI](https://www.mdpi.com/1424-8220/25/3/783)
...
* [clock drift]({{ 'clock-drift/' | relative_url }}) between the camera and ADS-B receiver;
* interpolation errors when ADS-B updates are less frequent than video frames;
* GPS position uncertainty for either the aircraft or the observing station. [MDPI+2docs.adaptive-vision.com](https://www.mdpi.com/1424-8220/25/3/783)
