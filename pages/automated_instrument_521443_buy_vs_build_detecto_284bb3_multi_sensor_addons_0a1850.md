...
show_ads: true
description: Magnetometers, weather sensors, GPS and radio receivers can enrich a sighting record, but they do not prove anything alone.
hero_summary: Magnetometers, weather sensors, GPS and radio receivers can enrich a sighting record, but they do not prove anything alone.
layout: default
permalink: /sensor-add-ons/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /buy-or-build/
nav_short_title: Sensor Add ons
title: What Extra Sensors Actually Add
title_full: What Extra Sensors Actually Add
display_title_short: Sensor Add ons
display_title: Sensor Add ons
heading_title: What Extra Sensors Actually Add
page_heading_title: What Extra Sensors Actually Add
source_count: 16
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Software Trust
  heading_title: Should Sky Tracking Software Be Open?
date: '2026-06-25 12:52:00 '
header:
  og_image: /assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_multi_sensor_addons_0a1850-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_multi_sensor_addons_0a1850-Illustration-1.webp
image: /assets/images/automated_instrument_521443_buy_vs_build_detecto_284bb3_multi_sensor_addons_0a1850-Illustration-1-social.jpg
---

## Introduction

Extra sensors can make an automated UAP detector substantially more useful, but they do not make an observation more extraordinary. In both commercial systems and DIY [open-source]({{ 'open-source/' | relative_url }}) builds, [magnetometers]({{ 'magnetometers/' | relative_url }}), weather instruments, GPS receivers, radio-frequency (RF) receivers and other environmental sensors are best understood as providers of context rather than proof. Their value lies in helping investigators reconstruct what happened, eliminate ordinary explanations and compare independent measurements taken at the same time.
...
* Can [known aircraft]({{ 'known-aircraft/' | relative_url }}), satellites, weather phenomena or local infrastructure explain the observations?
