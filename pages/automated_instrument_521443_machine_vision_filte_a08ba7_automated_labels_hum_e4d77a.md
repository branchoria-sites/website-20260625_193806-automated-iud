...
show_ads: true
description: Machine-vision labels are useful triage signals, not final verdicts, because camera conditions and training data shape every result.
hero_summary: Machine-vision labels are useful triage signals, not final verdicts, because camera conditions and training data shape every result.
layout: default
permalink: /human-review/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /vision-filters/
nav_short_title: Human Review
title: Why the Software Should Not Be the Judge
title_full: Why the Software Should Not Be the Judge
display_title_short: Human Review
display_title: Human Review
heading_title: Why the Software Should Not Be the Judge
page_heading_title: Why the Software Should Not Be the Judge
source_count: 16
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why a Plane Can Still Look Unknown
header:
  og_image: /assets/images/automated_instrument_521443_machine_vision_filte_a08ba7_automated_labels_hum_e4d77a-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_machine_vision_filte_a08ba7_automated_labels_hum_e4d77a-Illustration-1.webp
image: /assets/images/automated_instrument_521443_machine_vision_filte_a08ba7_automated_labels_hum_e4d77a-Illustration-1-social.jpg
---
...
* Does it resemble known [categories]({{ 'categories/' | relative_url }}) such as aircraft, birds or insects?
...
* **[Weather]({{ 'weather/' | relative_url }}).** Rain, haze, fog and thermal turbulence reduce contrast and distort apparent shapes.
...
* Are there simultaneous radar, [ADS-B]({{ 'ads-b/' | relative_url }}) or weather observations?
...
<img src="{{ "/assets/images/automated_instrument_521443_machine_vision_filte_a08ba7_automated_labels_hum_e4d77a-Illustration-2-dark.svg" | relative_url }}" alt="Human Review illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_machine_vision_filte_a08ba7_automated_labels_hum_e4d77a-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_machine_vision_filte_a08ba7_automated_labels_hum_e4d77a-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
* precise [timing]({{ 'timing/' | relative_url }}) and geographic calibration.
...
* **[False positives]({{ 'false-positives/' | relative_url }})**, where ordinary objects are incorrectly labelled as anomalous.
