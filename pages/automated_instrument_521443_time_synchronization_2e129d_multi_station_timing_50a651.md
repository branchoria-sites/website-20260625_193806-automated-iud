...
show_ads: true
description: Two observing stations can strengthen a case only when their clocks are aligned closely enough to compare the same moving object.
hero_summary: Two observing stations can strengthen a case only when their clocks are aligned closely enough to compare the same moving object.
layout: default
...
title: Two Cameras Help Only If Their Clocks Agree
title_full: Two Cameras Help Only If Their Clocks Agree
display_title_short: Triangulation
display_title: Triangulation
heading_title: Two Cameras Help Only If Their Clocks Agree
page_heading_title: Two Cameras Help Only If Their Clocks Agree
source_count: 30
infographic_count: 3
planned_sections:
- Why synchronized stations are needed for 3 D tracks
...
next_link:
  ...
  heading_title: A Timestamp Without Uncertainty Is Not Enough
header:
  og_image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_multi_station_timing_50a651-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_multi_station_timing_50a651-Illustration-1.webp
image: /assets/images/automated_instrument_521443_time_synchronization_2e129d_multi_station_timing_50a651-Illustration-1-social.jpg
---
...
Small [clock errors]({{ 'clock-errors/' | relative_url }}) do not simply add [uncertainty]({{ 'uncertainty/' | relative_url }}); they can fundamentally alter the reconstructed event.
