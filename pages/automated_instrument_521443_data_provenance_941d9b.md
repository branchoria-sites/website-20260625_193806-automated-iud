...
- automated_instrument_521443_data_provenance_941d9b_index
...
show_ads: true
description: A strange event record is more valuable when every processing step and sensor state can be traced afterward.
hero_summary: A strange event record is more valuable when every processing step and sensor state can be traced afterward.
layout: default
permalink: /provenance/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
nav_short_title: Provenance
title: How Do You Trust a UAP Event File?
title_full: How Do You Trust a UAP Event File?
display_title_short: Provenance
display_title: Provenance
heading_title: How Do You Trust a UAP Event File?
page_heading_title: How Do You Trust a UAP Event File?
source_count: 128
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Can Radar Make UAP Tracks Clearer?
header:
  og_image: /assets/images/automated_instrument_521443_data_provenance_941d9b-overview-social.jpg
  preview_image: /assets/images/automated_instrument_521443_data_provenance_941d9b-overview.webp
image: /assets/images/automated_instrument_521443_data_provenance_941d9b-overview-social.jpg
---

## Introduction

A UAP event file is only as trustworthy as the trail behind it. For [automated instrumented UFO detectors]({{ 'automated-instrumented-ufo-detectors/' | relative_url }}), the key question is not simply “did the camera record something strange?” but “can another reviewer reconstruct exactly how that record was made, handled, processed, and interpreted?” Data provenance is the record of origin and transformation; chain of [custody]({{ 'custody/' | relative_url }}) is the record of control, access, transfer, and preservation. Together, they turn a clip into evidence that can be checked rather than merely watched.
...
1. **Raw layer:** native files from each sensor, preserved without enhancement.
2. **Calibration layer:** dark frames, flat fields, lens distortion models, timing checks, alignment data and sensor health.
3. **Context layer:** weather, aircraft, satellite, astronomical, drone, fireball and local site data.
4. **Processing layer:** software versions, scripts, model thresholds, manual edits and intermediate outputs.
5. **Interpretation layer:** hypotheses tested, explanations rejected, confidence levels and unresolved questions.
6. **Custody layer:** identifiers, hashes, access logs, transfers, exports and publication history.
