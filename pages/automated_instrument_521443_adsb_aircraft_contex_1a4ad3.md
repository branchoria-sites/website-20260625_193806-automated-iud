...
- automated_instrument_521443_adsb_aircraft_contex_1a4ad3_index
...
show_ads: true
description: Aircraft tracking data helps detectors decide whether a bright moving object is unusual or just poorly recognized traffic.
hero_summary: Aircraft tracking data helps detectors decide whether a bright moving object is unusual or just poorly recognized traffic.
layout: default
permalink: /ads-b/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
nav_short_title: ADS B
title: How Aircraft Tracking Filters UAP Alerts
title_full: How Aircraft Tracking Filters UAP Alerts
display_title_short: ADS B
display_title: ADS B
heading_title: How Aircraft Tracking Filters UAP Alerts
page_heading_title: How Aircraft Tracking Filters UAP Alerts
source_count: 102
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Normal Sky Data Matters Most
header:
  og_image: /assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3-overview-social.jpg
  preview_image: /assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3-overview.webp
image: /assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3-overview-social.jpg
---
...
<img src="{{ "/assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3-Illustration-1-dark.svg" | relative_url }}" alt="ADS B illustration 1" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_adsb_aircraft_contex_1a4ad3-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Where Aircraft Data Is Incomplete
...
1. **Aircraft-track source:** local receiver, public network, historical database, MLAT-derived track, official feed or a combination.
2. **Coverage status:** whether the receiver was operating, whether the relevant sky sector had good reception, and whether network data were available.
3. **Matching tolerance:** the time window, angular separation and range assumptions used to compare the object with aircraft tracks.
4. **Match result:** strong aircraft match, possible aircraft match, nearby but inconsistent aircraft, no known transmitting aircraft, or insufficient aircraft data.
5. **Escalation reason:** why the event remains interesting despite aircraft context, such as inconsistent motion, multi-sensor corroboration, lack of ADS-B coverage, or a non-aircraft signature.
