...
show_ads: true
description: A magnetic spike only becomes meaningful when it is local, time-locked to another detection, checked against equipment faults, and archived with metadata.
hero_summary: A magnetic spike only becomes meaningful when it is local, time-locked to another detection, checked against equipment faults, and archived with metadata.
layout: default
permalink: /credible-spike/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /magnetometers/
nav_short_title: Credible Spike
title: When is a magnetic spike worth attention?
title_full: When is a magnetic spike worth attention?
display_title_short: Credible Spike
display_title: Credible Spike
heading_title: When is a magnetic spike worth attention?
page_heading_title: When is a magnetic spike worth attention?
source_count: 32
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: What Galileo learned from magnetic monitoring
header:
  og_image: /assets/images/automated_instrument_521443_magnetometers_088bec_credible_magnetic_an_fc5fce-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_magnetometers_088bec_credible_magnetic_an_fc5fce-Illustration-1.webp
image: /assets/images/automated_instrument_521443_magnetometers_088bec_credible_magnetic_an_fc5fce-Illustration-1-social.jpg
---
...
The strongest single characteristic of a potentially useful magnetic anomaly is accurate [timing]({{ 'timing/' | relative_url }}).

A magnetometer should record continuously using a stable clock, preferably synchronised through GPS or another reliable time source. If an optical camera, infrared sensor, [radar]({{ 'radar/' | relative_url }}), acoustic array or radio receiver independently records an unusual event, the magnetic record can then be examined around exactly the same time window.
...
* UTC [timestamps]({{ 'timestamps/' | relative_url }}) with known clock accuracy.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/az8KzgoE1Tw" title="Earth’s Magnetic Weak Spot: The Mystery of the South Atlantic Anomaly" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=az8KzgoE1Tw" target="_blank" rel="noopener noreferrer">Earth’s Magnetic Weak Spot: The Mystery of the South Atlantic Anomaly</a></p><p class="youtube-embed-meta">Channel: EarthSky</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=az8KzgoE1Tw" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=az8KzgoE1Tw">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/automated_instrument_521443_magnetometers_088bec_credible_magnetic_an_fc5fce-Illustration-3-dark.svg" | relative_url }}" alt="Credible Spike illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_magnetometers_088bec_credible_magnetic_an_fc5fce-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_magnetometers_088bec_credible_magnetic_an_fc5fce-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
