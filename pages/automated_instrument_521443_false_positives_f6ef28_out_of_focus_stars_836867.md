...
show_ads: true
description: Stars near poor focus or lens edges can become glowing discs, making a fixed point seem like an object with size and structure.
hero_summary: Stars near poor focus or lens edges can become glowing discs, making a fixed point seem like an object with size and structure.
layout: default
permalink: /star-discs/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /false-positives/
nav_short_title: Star Discs
title: When Stars Turn Into Glowing Discs
title_full: When Stars Turn Into Glowing Discs
display_title_short: Star Discs
display_title: Star Discs
heading_title: When Stars Turn Into Glowing Discs
page_heading_title: When Stars Turn Into Glowing Discs
source_count: 31
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How Starlink Trains Become UAP Reports
header:
  og_image: /assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-1.webp
image: /assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-2-dark.svg" | relative_url }}" alt="Star Discs illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<img src="{{ "/assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-3-dark.svg" | relative_url }}" alt="Star Discs illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_false_positives_f6ef28_out_of_focus_stars_836867-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Simple Checks Using Star Charts and Camera Metadata
...
3. **[Review]({{ 'review/' | relative_url }}) focus information.** Large stellar images, focus-hunting behaviour or known focus errors strongly support an optical explanation.

<div class="content-enhancement content-enhancement--step-flow" markdown="1">

4. **Compare centre and edge appearance.** If stars near the frame edge show unusual shapes while central stars appear normal, lens aberrations are a likely cause.
5. **Examine metadata.** Exposure time, focal length, focus settings and zoom level often reveal whether the camera was operating in a regime prone to star-disc artefacts.
6. **Use multiple sensors.** A true physical object should be observable across independent instruments. A defocused star will typically appear only as an optical signature consistent with the camera's characteristics.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Discusses focus, image artifacts, optical effects, and how point sources are rendered by cameras.</p>
        <div class="fr-book-actions">
