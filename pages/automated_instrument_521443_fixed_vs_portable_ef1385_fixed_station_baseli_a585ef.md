...
show_ads: true
description: A fixed station becomes useful when repeated ordinary sky records make later strange events easier to judge.
hero_summary: A fixed station becomes useful when repeated ordinary sky records make later strange events easier to judge.
layout: default
permalink: /fixed-baselines/
sidebar_expanded_urls:
- /automated-instrumented-ufo-detectors/
- /fixed-vs-portable/
nav_short_title: Fixed Baselines
title: When Does a Fixed Station Earn Trust?
title_full: When Does a Fixed Station Earn Trust?
display_title_short: Fixed Baselines
display_title: Fixed Baselines
heading_title: When Does a Fixed Station Earn Trust?
page_heading_title: When Does a Fixed Station Earn Trust?
source_count: 15
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why GREMLIN Watches the Ordinary First
header:
  og_image: /assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-1-social.jpg
  preview_image: /assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-1.webp
image: /assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-1-social.jpg
---
...
Within the broader choice between portable and fixed detector stations, this is the defining advantage of a permanent installation. A mobile system can investigate reports in new locations, but only a long-running station can answer the question: "Is this event genuinely unusual for this place?"
...
* [weather effects]({{ 'weather-effects/' | relative_url }}) including cloud reflections, haze and temperature inversions;
...
* [timing]({{ 'timing/' | relative_url }}) accuracy between multiple sensors;
...
<img src="{{ "/assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-2-dark.svg" | relative_url }}" alt="Fixed Baselines illustration 2" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How long-term clutter records change anomaly claims
...
* insects producing characteristic out-of-focus streaks near [infrared cameras]({{ 'infrared/' | relative_url }});
...
<img src="{{ "/assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-3-dark.svg" | relative_url }}" alt="Fixed Baselines illustration 3" data-theme-src-dark="{{ "/assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/automated_instrument_521443_fixed_vs_portable_ef1385_fixed_station_baseli_a585ef-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why baseline quality matters more than event count

A common misunderstanding is that a successful fixed station should maximise the number of unusual detections. Scientific monitoring aims for the opposite: it seeks to minimise [uncertainty]({{ 'uncertainty/' | relative_url }}) about ordinary observations so that genuinely exceptional events, if they occur, stand out with stronger evidential support.
